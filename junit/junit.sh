#!/bin/bash
rm -rf /home/coder/project/workspace/toystore/target/surefire-reports;
src_directory="/home/coder/project/workspace/toystore/src"
 
if [ -d "$src_directory" ]; then
    cp -r /home/coder/project/workspace/junit/test "$src_directory"
    cd /home/coder/project/workspace/toystore;
    mvn -q test
else
